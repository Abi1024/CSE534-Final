...
public class Topo2 {
    ...
    /*this is the forwarding table for each node in the topology. Basically, if given a node A, and we know that in order to get from A to C, A must first go to its neighbor B, we add the entry
    ...
    public static void setup_routing_table(String this_ip, Routing_Table router, HashMap<String,ObjectOutputStream> out, PrintWriter writer) throws Exception{
        switch(this_ip){
            ...
            case "1.1.1.2":
                ...
                break;
            case "1.1.2.2":
                router.routing_table.put("1.1.1.1","1.1.2.1");
                router.routing_table.put("1.1.1.2","1.1.2.1");
                router.routing_table.put("1.1.3.1","1.1.2.1");
                router.routing_table.put("1.1.4.2","1.1.4.2");
                router.gateways.add("1.1.2.1");
                router.gateways.add("1.1.4.2");
                break;
            case "1.1.3.1":
                router.routing_table.put("1.1.1.1","1.1.3.2");
                router.routing_table.put("1.1.1.2","1.1.3.2");
                router.routing_table.put("1.1.2.2","1.1.3.2");
                router.routing_table.put("1.1.4.2","1.1.3.2");
                router.gateways.add("1.1.3.2");
                break;
            case "1.1.4.1":
                router.routing_table.put("1.1.1.1","1.1.4.1");
                router.routing_table.put("1.1.1.2","1.1.4.1");
                router.routing_table.put("1.1.3.1","1.1.4.1");
                router.routing_table.put("1.1.2.1","1.1.4.1");
...
>>>>>>> 87ba4c1ae795e87780801835f92e86d265b86b05
