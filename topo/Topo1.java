    ...
    public static void setup_routing_table(String this_ip, Routing_Table router, HashMap<String,ObjectOutputStream> out, PrintWriter writer) throws Exception{
        switch(this_ip){
            ...
            case "1.1.2.1":
                ...
                router.routing_table.put("1.1.4.1","1.1.2.2");
                router.gateways.add("1.1.2.2");
                break;
            case "1.1.3.1":
                router.routing_table.put("1.1.1.1","1.1.3.2");
                router.routing_table.put("1.1.1.2","1.1.3.2");
                router.routing_table.put("1.1.2.1","1.1.3.2");
                router.routing_table.put("1.1.4.1","1.1.3.2");
                router.gateways.add("1.1.3.2");
                break;
            case "1.1.4.1":
                router.routing_table.put("1.1.1.1","1.1.4.2");
                router.routing_table.put("1.1.1.2","1.1.4.2");
                router.routing_table.put("1.1.3.1","1.1.4.2");
                router.routing_table.put("1.1.2.1","1.1.4.2");
